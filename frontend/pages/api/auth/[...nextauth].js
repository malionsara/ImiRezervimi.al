...
export default NextAuth({
  ...
  providers: [
    // Instagram Login using Meta App
    {
      id: "instagram",
      name: "Instagram",
      type: "oauth",
        ...
        async request({ tokens }) {
          try {
            ...
            if (!profileResponse.ok) {
              ...
              throw new Error(`Instagram profile fetch failed: ${errorText}`);
            }
            
            const profile = await profileResponse.json();
            console.log('✅ Instagram profile fetch successful', profile);
            
            return {
              id: profile.id,
              name: profile.username,
              email: null, // Instagram Basic Display doesn't provide email
