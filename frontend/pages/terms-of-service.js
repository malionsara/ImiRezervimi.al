    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Kushtet e Shërbimit</h1>
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Përshkrimi i Shërbimit</h2>
              <p>
            ...
            {/* User Account */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Llogaria e Përdoruesit</h2>
            ...
            {/* Booking Terms */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Kushtet e Rezervimit</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Disponueshmëria e Platformës</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            {/* Disclaimers */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">8. Mohimet e Përgjegjësisë</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Kufizimi i Përgjegjësisë</h2>
              <p>
            ...
            {/* Termination */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">10. Ndërprerja</h2>
              <p>
            ...
            {/* Applicable Law */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">11. Ligji i Zbatueshëm</h2>
              <p>
            ...
            {/* Changes to Terms */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">12. Ndryshime në Kushte</h2>
              <p>
            ...
            {/* Contact */}
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">13. Kontakti</h2>
              <p>
                Për pyetje rreth këtyre Kushteve:
              </p>
              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                <p><strong>Email:</strong> <a href="mailto:support@imirezervimi.al" className="text-red-600 hover:underline">support@imirezervimi.al</a></p>
