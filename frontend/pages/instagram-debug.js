          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                {config ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-700 mb-2">Client ID</h3>
                      <p className="text-sm font-mono bg-white p-2 rounded border">
                        {config.clientId ? `${config.clientId.substring(0, 8)}...` : 'Not configured'}
                      </p>
                    </div>
                    <div>
                      <h3 className="font-semibold text-gray-700 mb-2">Client Secret</h3>
                      <p className="text-sm font-mono bg-white p-2 rounded border">
            ...
            <div className="mb-8">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                <h3 className="font-semibold text-blue-800 mb-3">Go to Facebook Developers Console:</h3>
                ...
                <div className="mt-4 space-y-2">
                  <div className="bg-white p-3 rounded border border-blue-300">
                    ...
                    <span className="ml-2 text-green-600 font-semibold">← Primary (www)</span>
                  </div>
                  <div className="bg-white p-3 rounded border border-blue-300">
                    <code className="text-sm">https://imirezervimi.al/api/auth/callback/instagram</code>
                    <span className="ml-2 text-yellow-600 font-semibold">← Fallback (no www)</span>
                  </div>
                </div>
            ...
            {config?.clientId && (
              <div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <p className="text-sm text-gray-600 mb-2">This is the exact URL that will be used for Instagram OAuth:</p>
