      ...
      {step === 'phone' && (
        <div className="space-y-6">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={loading}
                className="block w-full pl-12 pr-4 py-4 border border-linen rounded-lg text-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              />
            </div>
          ...
          <button
            ...
            className="w-full flex justify-center items-center py-4 px-6 border border-transparent text-lg font-semibold rounded-lg text-white bg-success hover:bg-accent-strong focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform disabled:transform-none"
          >
            {loading ? (
              <>
        ...
        <div className="space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="123456"
              disabled={loading}
              className="block w-full px-4 py-4 border border-linen rounded-lg text-lg text-center placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 tracking-widest font-mono"
              maxLength={6}
            ...
            <div className="mt-2 flex justify-between items-center text-sm">
              ...
              {countdown > 0 ? (
                ...
                <button
                  onClick={handleSendCode}
                  disabled={loading}
                  className="text-success hover:text-success font-medium disabled:opacity-50"
                >
                  Dërgo përsëri kodin
                </button>
              )}
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 text-clay hover:text-ink font-medium disabled:opacity-50 transition-colors duration-200"
          >
