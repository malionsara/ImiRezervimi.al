...
// Playwright configuration for ImiRezervimi.al E2E testing
// Comprehensive testing setup for Albanian Beauty Salon Booking Platform
...
export default defineConfig({
  ...
  /* Don't fail on flaky tests in CI - we want to see overall results */
  ...
  use: {
    ...
    baseURL: process.env.TEST_BASE_URL || process.env.BASE_URL || 'http://localhost:3000',
